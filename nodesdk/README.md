...
- [Table of Contents](#table-of-contents)
  ...
  - [Examples](#examples)
    ...
    - [Ring example using typescript and plain promises](#ring-example-using-typescript-and-plain-promises)
...
Latest **STABLE** release is  [distributed on npmjs.com](https://www.npmjs.com/package/@gnaudio/jabra-node-sdk/) (see [changelog](../CHANGELOG.md) for changes and notable defects).
